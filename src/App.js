...
const App = () => {
        ...
        <section id="home" className="hero">
          <div className="hero-content">
            ...
            <div className="cta-buttons">
              <a href="#dao-create" className="cta-button">Get Started</a>
            </div>
          </div>
        </section>
  ...
  />
      ...
      <div className="headings-container">
        <h2 className="heading-first-heading">Designed for the full journer</h2>
        <h2 className="heading">Organization design</h2>
        <h2 className="heading">Samart contract development</h2>
        <h2 className="heading">Fundraising</h2>
        <h2 className="heading">Launch marketing</h2>
        <h2 className="heading">Member onboarding</h2>
        <h2 className="heading">Contrabutor menagement</h2>
